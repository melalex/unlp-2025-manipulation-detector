...
loaded_language = """
The use of words and phrases with a strong emotional connotation (positive or negative) to influence the audience.
...
Exploitation of people's positive attitude towards abstract concepts such as “justice,” “freedom,” “democracy,” “patriotism,” “peace,” “happiness,” “love,” “truth,” “order,” etc. These words and phrases are intended to provoke strong emotional reactions and feelings of solidarity without providing specific information or arguments.
...
"""
euphoria = """ 
Using an event that causes euphoria or a feeling of happiness, or a positive event to boost morale. This manipulation is often used to mobilize the population.
...
appeal_to_fear = """
The misuse of fear (often based on stereotypes or prejudices) to support a particular proposal.
...
"""
fud = """
Presenting information in a way that sows uncertainty and doubt, causing fear. This technique is a subtype of the appeal to fear.
...
bandwagon = """
An attempt to persuade the audience to join and take action because “others are doing the same thing.”
...
cliche = """
Commonly used phrases that mitigate cognitive dissonance and block critical thinking.
...
whataboutism = """
Discrediting the opponent's position by accusing them of hypocrisy without directly refuting their arguments.
...
cherry_picking = """
Selective use of data or facts that support a hypothesis while ignoring counterarguments.
...
straw_man = """ 
Distorting the opponent's position by replacing it with a weaker or outwardly similar one and refuting it instead.
...
with open('src/data/technique_descriptions.json', 'w', encoding='utf-8') as json_file:
    json.dump(data, json_file, ensure_ascii=False, indent=4)

print("Дані успішно записані у файл json")